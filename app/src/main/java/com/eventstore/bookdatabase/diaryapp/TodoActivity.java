...
public class TodoActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		AppManage.getInstance(TodoActivity.this).loadInterstitialAd(this);
		AppManage.getInstance(TodoActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View _view) {
				AppManage.getInstance(TodoActivity.this).showInterstitialAd(TodoActivity.this, new AppManage.MyCallback() {
		...
		pholder.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View _view) {
