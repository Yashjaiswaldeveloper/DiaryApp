...
public class NextExpenseActivity extends AppCompatActivity {

    private Spinner expense_typeSP;
    private TextView expense_docBTN,expense_dateBTN,expense_timeBTN,add_expenseBTN;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_next_expense);
        ...
        add_expenseBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(type.equals("Select expense type")){
                    Toast.makeText(NextExpenseActivity.this, "Please select an expense type.", Toast.LENGTH_SHORT).show();
                }
                else if(amount.equals("")){
                    Toast.makeText(NextExpenseActivity.this, "Enter amount.", Toast.LENGTH_SHORT).show();
                }
                else if(date.equals("")){
                    Toast.makeText(NextExpenseActivity.this, "Enter date.", Toast.LENGTH_SHORT).show();
                }
                    ...
                    if(idIntent != null){
                        ...
                        if(bitmappic != null){
                            ...
                            if (resultId > 0){
                                Toast.makeText(NextExpenseActivity.this, "Updated Successfully.", Toast.LENGTH_SHORT).show();
                                //finish();
                                Intent intent = new Intent(NextExpenseActivity.this, SaveSuccessfullyTwoActivity.class);
                                intent.putExtra("setScreen","1");
                                startActivity(intent);
                                finish();
                            }
                            else {
                                Toast.makeText(NextExpenseActivity.this, "Data did not update.", Toast.LENGTH_SHORT).show();
                            }
                        }
                        else {
                        ...
                        if(bitmappic !=null){
                            ...
                            if(resultId > 0){
                                setResult(RESULT_OK);
                                Toast.makeText(NextExpenseActivity.this, "Data inserted Successfully.", Toast.LENGTH_SHORT).show();
                                //finish();
                                Intent intent = new Intent(NextExpenseActivity.this,SaveSuccessfullyTwoActivity.class);
                                intent.putExtra("setScreen","1");
                                startActivity(intent);
                                ...
                                Toast.makeText(NextExpenseActivity.this, "Data did not insert.", Toast.LENGTH_SHORT).show();
                            }
                        }
                        else {
                            ...
                            if(resultId > 0){
                                ...
                                Toast.makeText(NextExpenseActivity.this, "Data did not inserted.", Toast.LENGTH_SHORT).show();
                            }
                        }
    ...
    private void gettime() {
        ...
        expense_timeBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(NextExpenseActivity.this);
    ...
    private void getdate() {
        expense_dateBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(NextExpenseActivity.this,dateSetListener,year,month,day);
    ...
    private void setspinner() {
        ArrayAdapter<String> dataApater = new ArrayAdapter<>(this, androidx.appcompat.R.layout.support_simple_spinner_dropdown_item,categories);
        dataApater.setDropDownViewResource(androidx.appcompat.R.layout.support_simple_spinner_dropdown_item);
