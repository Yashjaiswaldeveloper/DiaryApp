...
import com.eventstore.bookdatabase.diaryapp.DialyExpenseActivity;
import com.eventstore.bookdatabase.diaryapp.NextExpenseActivity;
...
public class ExpenseAdapter extends RecyclerView.Adapter<ExpenseAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder,int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                expenseAmount.setText(expense.getExpense_amount()+" INR");
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        switch (menuItem.getItemId()){
                            ...
                            case R.id.nav_delete:
                              Cursor cursor = DialyExpenseActivity.helper.getSpecificData("SELECT Id FROM expense");
    ...
    private void update(Expense expense) {
        Intent intent = new Intent(context, NextExpenseActivity.class);
    ...
    private void showDeleteDialog(final int rowId, final int position) {
        ...
        deleteDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    DialyExpenseActivity.helper.deleteDataFromDatabase(rowId);
