...
public class ShopActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		AppManage.getInstance(ShopActivity.this).loadInterstitialAd(this);
		AppManage.getInstance(ShopActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View _view) {
				AppManage.getInstance(ShopActivity.this).showInterstitialAd(ShopActivity.this, new AppManage.MyCallback() {
		...
		addph.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View _view) {
		...
		mic.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View _view) {
				if (ismic) {
					...
					mic.setImageResource(R.drawable.mic_checked);
					vib.vibrate((long)(100));
		...
		favthis.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View _view) {
				if (setfav) {
					setfav = false;
					favthis.setImageResource(R.drawable.star_uncheck);
				}
				else {
					setfav = true;
					favthis.setImageResource(R.drawable.star_checked);
				}
			}
		});
		
		addthis.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View _view) {
				AppManage.getInstance(ShopActivity.this).showInterstitialAd(ShopActivity.this, new AppManage.MyCallback() {
					public void callbackCall() {
