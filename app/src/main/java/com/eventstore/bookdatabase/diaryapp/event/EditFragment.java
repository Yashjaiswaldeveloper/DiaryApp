...
import com.eventstore.bookdatabase.diaryapp.databinding.EventEditBinding;
...
//        ((AppCompatActivity)getActivity()).getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    private void delete(){
        AlertDialog deleteDialog = new AlertDialog.Builder(getActivity(), com.google.android.material.R.style.Theme_MaterialComponents_Light_Dialog_Alert)
