...
public class NotesActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		AppManage.getInstance(NotesActivity.this).loadInterstitialAd(this);
		AppManage.getInstance(NotesActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View _view) {
				AppManage.getInstance(NotesActivity.this).showInterstitialAd(NotesActivity.this, new AppManage.MyCallback() {
		...
		fonly.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View _view) {
